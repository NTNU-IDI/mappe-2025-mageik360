...
class DiaryEntryTest {
   ...
   *
   * <p>assertEquals for author object, title, text and time.
   */
  @Test
   ...
   *
   * <p>assertThrows for null and empty strings.
   */
  @Test
   ...
   *
   * <p>assertEquals for trimmed text and title. assertThrows for empty/null text.
   */
  @Test
  void setters_trim_and_validate() {
    DiaryEntry diaryEntry =
        new DiaryEntry(new Author("Linda", dummyPassword), "Title", "Text", LocalDateTime.now());
   ...
   *
   * <p>assertEquals for valid text and title.
   */
  @Test
   ...
   *
   * <p>assertThrows for too long text. assertThrows for too long title.
   */
  @Test
  void constructor_reject_over_max_lengths() {
    ...
    assertThrows(
        ...
        () -> new DiaryEntry(a, tooLongTitle, okText, LocalDateTime.of(2025, 1, 1, 10, 10)));
    String okTitle = "Title";
    String tooLongText = repeat('A', DiaryEntry.TEXT_MAX_LENGTH + 1);
    assertThrows(
        IllegalArgumentException.class,
        () -> new DiaryEntry(a, okTitle, tooLongText, LocalDateTime.of(2025, 1, 1, 10, 10)));
  }

  /**
   * Test to check that setters enforce limits and trimming.
   *
   * <p>assertEquals for valid trimmed title and text. assertThrows for title and text exceeding
   * maximum length.
   */
  @Test
  void setters_enforce_limits_and_trimming() {
    DiaryEntry e =
        new DiaryEntry(
            new Author("Leonora", dummyPassword),
            "Title",
            "Text",
